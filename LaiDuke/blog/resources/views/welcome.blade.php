                ...
                <div class="text-inner d-flex align-items-center">
                    <div class="content">
                        <header class="post-header">
                            <div class="category"><a href="#">{{$Post->category->name}}</a></div><a href="post">
        ...
        <div class="row">
            @foreach($lastestPost as $Post)
                <div class="post col-md-4">
                    <div class="post-thumbnail"><a href="post"><img src="{{$Post->cover}}" alt="..." class="img-fluid"></a></div>
